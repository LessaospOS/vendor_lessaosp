...
bacon: $(INTERNAL_OTA_PACKAGE_TARGET)
	...
	echo -e ${CL_BLD}${CL_GRN}"Filehash: "${CL_RED}" `md5sum $(LESSAOSP_TARGET_PACKAGE) | awk '{print $$1}' `"${CL_RST}
	echo -e ${CL_BLD}${CL_GRN}"Filename: "${CL_RED} $(LESSAOSP_TARGET_PACKAGE)${CL_RST}
	echo -e ${CL_BLD}${CL_GRN}"ID: "${CL_RED}" `cat $(LESSAOSP_TARGET_PACKAGE).sha256sum | awk '{print $$1}' `"${CL_RST}
